/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/cbuild/slaves/oorts/crosstool-ng/builds/aarch64_be-none-elf-linux/.build/src/gcc-linaro-4.8-2014.04/gcc/config/aarch64/aarch64.md'.  */
